  ...
  Widget build(BuildContext context) {
    ...
    var slider = Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
              newGrade.title, style: TextStyle(fontSize: width/20, fontWeight: FontWeight.bold),),
          Row(children: [
            
            Text(  'Grade: ' + newGrade.grade.toStringAsFixed(1) + '%', style: TextStyle(fontSize: width/25),),
                                                ...
                                                RaisedButton(
                                                  onPressed: () {
                                                    if (_formKey.currentState
                                                        .validate()) {
                                                      var grade = double.parse( _gradeFormKey
                                                          .currentState.value);
                                                      ...
                                                      grades.retainWhere((element) => element.id != updatedGrade.id);
          ...
          Row(
            children: [
              Text(  'Weight: ' + newGrade.weight.toStringAsFixed(1) + '%', style: TextStyle(fontSize: width/25),),
            ],
          ),
